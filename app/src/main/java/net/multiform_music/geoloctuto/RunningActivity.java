...
import net.multiform_music.geoloctuto.bean.ChronometerBean;
import net.multiform_music.geoloctuto.bean.ChronometerBeanSavedState;
import net.multiform_music.geoloctuto.bean.NotificationBean;
import net.multiform_music.geoloctuto.bean.RunningBean;
...
import net.multiform_music.geoloctuto.service.ChronometerService;
...
public class RunningActivity extends AppCompatActivity implements FragmentParameter.ChangeTypeActivityListener {
    ...
    /**
     *
     * Réception données altitude du bus {@link net.multiform_music.geoloctuto.task.SaveRunnigStepTask}
     *
