...
import net.multiform_music.ifeelrun.R;
import net.multiform_music.ifeelrun.RunningActivity;
...
import net.multiform_music.ifeelrun.task.SaveRunnigStepTask;

import static net.multiform_music.ifeelrun.RunningActivity.runningStarted;
